<template>
  <div class="holder fullwidth mt-0 full-nopad">
    <div class="container">
      <div class="bnslider-wrapper">
        <div
          class="bnslider keep-scale"
          data-start-width="1920"
          data-start-height="864"
          data-start-mwidth="1200"
          data-start-mheight="1100"
          id="bnslider-1586195671359"
          data-autoplay="true"
          data-speed="15000"
        ...
        >
          <div class="bnslider-slide" data-autoplay="true" data-video-type="video">
            <div
              class="bnslider-image-mobile lazyload fade-up-fast"
              data-bgset="images/skins/books/slider/slide-books-01.png"
              data-sizes="auto"
            ></div>
            <div
              class="bnslider-image lazyload fade-up-fast"
              data-bgset="images/skins/books/slider/slide-books-01.png"
              data-sizes="auto"
            ></div>
              ...
              <div class="bnslider-text-content txt-middle txt-right txt-middle-m txt-right-m">
                <div class="bnslider-text-content-flex">
                  <div class="bnslider-vert w-s-40 w-ms-50 p-0">
                    <div
                      class="bnslider-text order-1 mt-0 bnslider-text--lg text-left heading-font"
                      ...
                      data-otherstyle=""
                    >
                      A wide range <br />of books
                    </div>
                    <div
                      class="bnslider-text order-2 mt-sm bnslider-text--xs text-left heading-font d-none d-md-block"
                      data-animation="fadeInUp"
                      ...
                      data-otherstyle=""
                    >
                      To meet any taste and budget.<br />Find the book you need!
                    </div>
            ...
            <div class="prd-img-area">
              <a href="product.html" class="prd-img image-hover-scale image-container">
                <img
                  ...
                  data-src="images/skins/books/products/product-01.png"
                  alt="The Book 01"
          ...
          <div class="prd-inside">
            <div class="prd-img-area">
              <a href="product.html" class="prd-img image-hover-scale image-container">
                <img
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                  data-src="images/skins/books/products/product-02.png"
                  alt="The Book 02"
                  class="js-prd-img lazyload fade-up"
                />
                <div class="foxic-loader"></div>
              ...
              <div class="prd-info-wrap">
                ...
                <div class="prd-action">
                  <form action="#">
                    <button
                      class="btn js-prd-addtocart"
                      data-product='{"name": "The Book 02", "path":"images/skins/books/products/product-02.png", "url":"product.html", "aspect_ratio":0.778}'
                    >
                      Add To Cart
                    </button>
                  </form>
          ...
          <div class="prd-inside">
            <div class="prd-img-area">
              <a href="product.html" class="prd-img image-hover-scale image-container">
                <img
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                  data-src="images/skins/books/products/product-03.png"
                  alt="The Book 03"
                  class="js-prd-img lazyload fade-up"
                />
                <div class="foxic-loader"></div>
              ...
              <div class="prd-info-wrap">
                ...
                <div class="prd-action">
                  <form action="#">
                    <button
                      class="btn js-prd-addtocart"
                      data-product='{"name": "The Book 03", "path":"images/skins/books/products/product-03.png", "url":"product.html", "aspect_ratio":0.778}'
                    >
                      Add To Cart
                    </button>
                  </form>
          ...
          <div class="prd-inside">
            <div class="prd-img-area">
              <a href="product.html" class="prd-img image-hover-scale image-container">
                <img
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                  data-src="images/skins/books/products/product-04.png"
                  alt="The Book 04"
                  class="js-prd-img lazyload fade-up"
                />
                <div class="foxic-loader"></div>
              ...
              <div class="prd-info-wrap">
                ...
                <div class="prd-action">
                  <form action="#">
                    <button
                      class="btn js-prd-addtocart"
                      data-product='{"name": "The Book 04", "path":"images/skins/books/products/product-04.png", "url":"product.html", "aspect_ratio":0.778}'
                    >
                      Add To Cart
                    </button>
                  </form>
          ...
          <div class="prd-inside">
            <div class="prd-img-area">
              <a href="product.html" class="prd-img image-hover-scale image-container">
                <img
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                  data-src="images/skins/books/products/product-05.png"
                  alt="The Book 05"
                  class="js-prd-img lazyload fade-up"
                />
                <div class="foxic-loader"></div>
              ...
              <div class="prd-info-wrap">
                ...
                <div class="prd-action">
                  <form action="#">
                    <button
                      class="btn js-prd-addtocart"
                      data-product='{"name": "The Book 05", "path":"images/skins/books/products/product-05.png", "url":"product.html", "aspect_ratio":0.778}'
                    >
                      Add To Cart
                    </button>
                  </form>
  ...
  <div
    class="holder holder-mt-medium section-name-products-grid holder-with-bg holder-pt-medium holder-pb-medium"
    id="productsGrid01"
  ...
  >
    <div class="container">
      <div class="title-wrap text-center">
        ...
        <div class="title-wrap title-tabs-wrap text-center js-title-tabs">
          <div class="title-tabs">
            <h2 class="h3-style">
              <a href="ajax/ajax-product-tab-books-01.json" data-total="5" data-loaded="5" data-grid-tab-title
                ><span class="title-tabs-text theme-font">Romance</span></a
              >
            </h2>
            <h2 class="h3-style">
              <a href="ajax/ajax-product-tab-books-02.json" data-total="5" data-loaded="5" data-grid-tab-title
                ><span class="title-tabs-text theme-font">Adventure</span></a
              >
            </h2>
            <h2 class="h3-style">
              <a href="ajax/ajax-product-tab-books-03.json" data-total="5" data-loaded="5" data-grid-tab-title
                ><span class="title-tabs-text theme-font">Poetry</span></a
              >
            </h2>
            <h2 class="h3-style">
              <a href="ajax/ajax-product-tab-books-04.json" data-total="5" data-loaded="5" data-grid-tab-title
                ><span class="title-tabs-text theme-font">Thriller</span></a
              >
            </h2>
          </div>
        </div>
      ...
      <div class="prd-grid-wrap">
        <div
          class="prd-grid data-to-show-5 data-to-show-md-3 data-to-show-sm-2 data-to-show-xs-2"
  ...
  <div class="holder mt-0 holder-with-bg pt-0 holder-pb-medium" style="background-color: #fcfcfc">
    <div class="container">
      <div class="title-wrap text-center"><h2 class="h1-style">Author Of The Week</h2></div>
      <div class="row vert-margin-small">
        ...
        <div class="col-18 col-md-6 align-self-center">
          <div
            class="prd-grid prd-carousel js-prd-carousel-dots prd-carousel--single-sm data-to-show-1 data-to-show-lg-1 data-to-show-md-1 data-to-show-sm-2 data-to-show-xs-1"
              ...
              <div class="prd-inside">
                <div class="prd-img-area">
                  <a href="product.html" class="prd-img image-hover-scale image-container">
                    <img
                      src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                      data-src="images/skins/books/products/product-24.png"
                      alt="The Book 24"
                      class="js-prd-img lazyload fade-up"
                    />
                    <div class="foxic-loader"></div>
                    ...
                    <div class="prd-action">
                      <div class="prd-action-left">
                        <form action="#">
                          <button
                            class="btn js-prd-addtocart"
                            data-product='{"name": "The Book 24", "path":"images/skins/books/products/product-24.png", "url":"product.html", "aspect_ratio":0.778}'
                          >
                            Add To Cart
                          </button>
                        </form>
              ...
              <div class="prd-inside">
                <div class="prd-img-area">
                  <a href="product.html" class="prd-img image-hover-scale image-container">
                    <img
                      src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                      data-src="images/skins/books/products/product-26.png"
                      alt="The Book 25"
                      class="js-prd-img lazyload fade-up"
                    />
                    <div class="foxic-loader"></div>
                    ...
                    <div class="prd-action">
                      <div class="prd-action-left">
                        <form action="#">
                          <button
                            class="btn js-prd-addtocart"
                            data-product='{"name": "The Book 25", "path":"images/skins/books/products/product-26.png", "url":"product.html", "aspect_ratio":0.778}'
                          >
                            Add To Cart
                          </button>
                        </form>
            ...
            <div class="prd-inside">
              <div class="prd-img-area">
                <a href="product.html" class="prd-img image-hover-scale image-container">
                  <img
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="images/skins/books/products/product-21.png"
                    alt="The Book 21"
                    class="js-prd-img lazyload fade-up"
                  />
                  <div class="foxic-loader"></div>
                ...
                <div class="prd-info-wrap">
                  ...
                  <div class="prd-action">
                    <form action="#">
                      <button
                        class="btn js-prd-addtocart"
                        data-product='{"name": "The Book 21", "path":"images/skins/books/products/product-21.png", "url":"product.html", "aspect_ratio":0.778}'
                      >
                        Add To Cart
                      </button>
                    </form>
            ...
            <div class="prd-inside">
              <div class="prd-img-area">
                <a href="product.html" class="prd-img image-hover-scale image-container">
                  <img
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="images/skins/books/products/product-22.png"
                    alt="The Book 22"
                    class="js-prd-img lazyload fade-up"
                  />
                  <div class="foxic-loader"></div>
                ...
                <div class="prd-info-wrap">
                  ...
                  <div class="prd-action">
                    <form action="#">
                      <button
                        class="btn js-prd-addtocart"
                        data-product='{"name": "The Book 22", "path":"images/skins/books/products/product-22.png", "url":"product.html", "aspect_ratio":0.778}'
                      >
                        Add To Cart
                      </button>
                    </form>
            ...
            <div class="prd-inside">
              <div class="prd-img-area">
                <a href="product.html" class="prd-img image-hover-scale image-container">
                  <img
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="images/skins/books/products/product-23.png"
                    alt="The Book 23"
                    class="js-prd-img lazyload fade-up"
                  />
                  <div class="foxic-loader"></div>
                ...
                <div class="prd-info-wrap">
                  ...
                  <div class="prd-action">
                    <form action="#">
                      <button
                        class="btn js-prd-addtocart"
                        data-product='{"name": "The Book 23", "path":"images/skins/books/products/product-23.png", "url":"product.html", "aspect_ratio":0.778}'
                      >
                        Add To Cart
                      </button>
                    </form>
            ...
            <div class="prd-inside">
              <div class="prd-img-area">
                <a href="product.html" class="prd-img image-hover-scale image-container">
                  <img
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    data-src="images/skins/books/products/product-25.png"
                    alt="The Book 25"
                    class="js-prd-img lazyload fade-up"
                  />
                  <div class="foxic-loader"></div>
                ...
                <div class="prd-info-wrap">
                  ...
                  <div class="prd-action">
                    <form action="#">
                      <button
                        class="btn js-prd-addtocart"
                        data-product='{"name": "The Book 25", "path":"images/skins/books/products/product-25.png", "url":"product.html", "aspect_ratio":0.778}'
                      >
                        Add To Cart
                      </button>
                    </form>
      ...
      <div class="row bnr-grid vert-margin-small">
        <div class="col-18 col-sm-6">
          <a href="product.html" target="_self" class="bnr-wrap">
            <div
              class="bnr custom-caption image-hover-scale image-hover-scale--slow bnr--top bnr--left"
              data-fontratio="5.7"
            >
        ...
        <div class="col-18 col-sm-6">
          <a href="product.html" target="_self" class="bnr-wrap">
            <div
              class="bnr custom-caption image-hover-scale image-hover-scale--slow bnr--bottom bnr--left"
              data-fontratio="5.7"
            >
              <div class="bnr-img image-container" style="padding-bottom: 140.526%">
              ...
              <div class="bnr-caption" style="padding: 12% 12%; width: 100%">
                <div
                  class="bnr-text3 mt-sm order-2 inherit"
                  style="color: #000000; font-size: 0.725em; font-weight: 700; line-height: 1em"
                >
                  Discount
                </div>
                ...
                <div
                  class="bnr-text3 mt-lg order-3 inherit"
                  style="font-size: 0.275em; font-weight: 800; line-height: 1em"
                >
                  For Childrens Bokks
                </div>
              </div>
          ...
          <a href="product.html" target="_self" class="bnr-wrap">
            ...
            >
              ...
              <div class="bnr-caption" style="padding: 18% 14%; width: 100%">
                <div
                  class="bnr-text3 mt-0 order-1 inherit"
                  style="color: #000000; font-size: 0.725em; font-weight: 700; line-height: 1em"
                >
                  Hot<br />Proposition
                </div>
          ...
          <a href="product.html" target="_self" class="bnr-wrap">
            ...
            >
              ...
              <div class="bnr-caption" style="padding: 16% 14%; width: 100%">
                <div
                  class="bnr-text3 mt-sm order-1 text-left"
